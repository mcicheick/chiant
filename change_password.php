...
<TD> <INPUT type=password name="mdp1" id="mdp1"  '></INPUT>
</TD></TR>
<TR> <TD>Confirmation du mot de passe</TD>
<TD><INPUT type=password name="mdp2" id="mdp2" onkeyup='check_pass();'> </INPUT><span id='message'></span></TD>
