...
function update_user_sp_prefs($football, $basket){
   ...
   // Cette v�rification est inutile en principe, car la liste des sports ne change pas mais on
   ...
   foreach ($messports as $nomsport => $valsport) {
	...
	$id_user = checkLogged();
	// enl�ve les pr�f�rences de basket  et de football
	I\removeAffinitesSports($id_user, $liste_total);
	// mets les bonnes � la place
